...
class TraceroutesControllerTest < ActionController::TestCase
  ...
  test "should create traceroute" do
    assert_difference('Traceroute.count') do
      post :create, traceroute: { exit_status: @traceroute.exit_status, server: @traceroute.server, stderr: @traceroute.stderr, stdout: @traceroute.stdout, timestamp: @traceroute.timestamp }
    end
  ...
  test "should update traceroute" do
    patch :update, id: @traceroute, traceroute: { exit_status: @traceroute.exit_status, server: @traceroute.server, stderr: @traceroute.stderr, stdout: @traceroute.stdout, timestamp: @traceroute.timestamp }
    assert_redirected_to traceroute_path(assigns(:traceroute))
  end
